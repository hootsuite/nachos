 ...
 *     </pre>
 */
public class UpdateableChipSpan extends ImageSpan implements Chip {
     ...
     * @param icon    an optional icon (can be {@code null}) for the ChipSpan to display
     */
    public UpdateableChipSpan(@NonNull Context context, @NonNull CharSequence text, @Nullable Drawable icon, Object data) {
        super(icon);
        mIcon = new StateListDrawable();
        mIcon.addState(new int[]{R.attr.state_image_placeholder}, icon);
        mIcon.setState(new int[]{R.attr.state_image_placeholder});
        mText = text;
        mTextToDraw = mText.toString();
     ...
     */
    public UpdateableChipSpan(@NonNull Context context, @NonNull UpdateableChipSpan chipSpan) {
        this(context, chipSpan.getText(), chipSpan.getStateListDrawable(), chipSpan.getData());
